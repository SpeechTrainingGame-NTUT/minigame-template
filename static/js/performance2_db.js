...
let goal = { x: 780, y: 140, width: 20, height: 20 }; // ゴールの初期化
...
function endGame(isCleared) {
    ...
    if (isCleared) {
        const resultURL = `/voice_jump_db/performance2_db_rslt?elapsedTime=${elapsedTime}&coinScore=${coinScore}&redCoins=${collectedCoins.red}&blueCoins=${collectedCoins.blue}&yellowCoins=${collectedCoins.yellow}`;
