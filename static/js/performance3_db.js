...
function endGame(isCleared) {
    ...
    if (isCleared) {
        ...
        const resultURL = `/voice_jump_db/performance3_db_rslt?elapsedTime=${elapsedTime}&coinScore=${coinScore}&redCoins=${collectedCoins.red}&blueCoins=${collectedCoins.blue}&yellowCoins=${collectedCoins.yellow}`;
